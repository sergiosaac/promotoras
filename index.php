...
<body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<li><a onclick="alert('En desarrollo! Prueba mas tarde.')" href="#">Promotoras</a></li>
			<li><a onclick="alert('En desarrollo! Prueba mas tarde.')" href="#">Coordinadores</a></li>
			<li><a onclick="alert('En desarrollo! Prueba mas tarde.')" href="#">Clientes</a></li>
			</ul>
		</div>
	</nav>
